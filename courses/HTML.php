                      ...
                      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-5">
                        ...
                        <div class="col">
                          <div class="card shadow-sm">
                            <a href="../videos/HTML_video.php"><img src="../images/HTML-Tutorials.png" width="100%" height ="50%" class="rounded"></a>
                            <div class="card-body">
                        ...
                        <div class="col">
                          <div class="card shadow-sm">
                            <a href="../videos/HTML_video.php?abcd"><img src="../images/HTML-Tutorials.png" width="100%" height ="50%" class="rounded"></a>
                            <div class="card-body">
