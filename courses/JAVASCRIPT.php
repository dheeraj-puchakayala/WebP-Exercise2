    ...
    <body>
        ...
        <div class="p-5 mb-4 bg-light rounded-3">
          <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold"><img src="../images/javascript.png" style="height: 180px; width: 180px;"> JavaScript</h1>
        ...
        <div class="container px-4 py-5">
          ...
          <div class="row g-4 py-5 row-cols-1 row-cols-lg-1">
            <div class="col d-flex align-items-start">
              <div>
                <h4>JavaScript: Design and Build Websites</h4>
                <ul>
                      ...
                      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-5">
                        ...
                        <div class="col">
                          <div class="card shadow-sm">
                            <a href="../videos/JAVASCRIPT_video.html"><img src="../images/JAVASCRIPT-Tutorials.png" width="100%" height ="50%" class="rounded"></a>
                            <div class="card-body">
                              <h6>JavaScript: Lecture 1</h6>
                              <hr>
                        ...
                        <div class="col">
                          <div class="card shadow-sm">
                            <a href="https://youtu.be/uxWO8Sd8PoY?list=PLsyeobzWxl7qtP8Lo9TReqUMkiOp446cV"><img src="../images/JAVASCRIPT-Tutorials.png" width="100%" height ="50%" class="rounded"></a>
                            <div class="card-body">
                              <h6>JavaScript: Lecture 2</h6>
                              <hr>
                              <div class="d-flex justify-content-between align-items-center">
                                <div class="list-group mx-0">
                                  <label class="list-group-item d-flex gap-2">
