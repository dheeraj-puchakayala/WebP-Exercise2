    ...
    <body>
      ...
      <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
          <h1 class="display-5 fw-bold"><img src="../images/ajax.png" height= "180px" width= "180px"> Asynchronous JavaScript And XML</h1>
          <h4 class="display-6 fw-bold" style = "margin-top: 30px;">AJAX: Lecture 1</h4>
        </div>
      </div>
      ...
      <div class="row" style="margin-left: 100px; margin-right: 50px; height:56.25%">
        <div style="width: 70%;">
            <div class="row" style="height: 100%;">
                  <iframe  src="https://www.youtube.com/embed/salY_Sm6mv4" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div style="width: 30%;"> 
            <div class="row" style="height: 100%;" >
