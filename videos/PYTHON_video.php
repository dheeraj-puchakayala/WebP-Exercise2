    ...
    <body>
      ...
      <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
          ...
          <h4 class="display-6 fw-bold" style = "margin-top: 30px;">Python: Lecture 1</h4>
        </div>
      </div>
      ...
      <div class="row" style="margin-left: 100px; margin-right: 50px; height:56.25%">
        <div style="width: 70%;">
            <div class="row" style="height: 100%;">
                  <iframe  src="https://www.youtube.com/embed/avO8alp-JG8" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div style="width: 30%;"> 
            <div class="row" style="height: 100%;" >
